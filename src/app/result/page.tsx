      ...
      {isQualified && (
        <>
          <SparkleEffect
            count={200}
            duration={4000}
            colors={["#FFD700", "#FFA500", "#FF69B4", "#00CED1", "#7B68EE", "#C0C0C0", "#FF1493"]}
          />
          <GlitterBomb density={250} speed={1.2} />
        </>
      )}
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-950 dark:to-slate-900 flex items-center justify-center px-4 py-12 transition-colors">
        <div className="w-full max-w-2xl">
          {/* Main Card */}
          <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg dark:shadow-xl dark:shadow-slate-900/50 overflow-hidden border dark:border-slate-700/50">
            {/* Header with conditional background */}
            <div
              className={`px-8 py-12 text-center ${
                isQualified
                  ? "bg-gradient-to-r from-emerald-50 dark:from-emerald-900/30 to-teal-50 dark:to-teal-900/30 border-b-4 border-emerald-200 dark:border-emerald-800"
                  : "bg-gradient-to-r from-amber-50 dark:from-amber-900/30 to-orange-50 dark:to-orange-900/30 border-b-4 border-amber-200 dark:border-amber-800"
              }`}
            >
              <h1
            ...
            <div className="px-8 py-12">
              <div className="flex flex-col items-center mb-12">
                <div
                  className={`relative w-40 h-40 mb-6 ${isQualified ? "animate-glow-pulse" : ""}`}
                >
                  ...
                  <svg className="absolute inset-0 w-full h-full" viewBox="0 0 160 160">
                    ...
                    <circle
                      ...
                      strokeWidth="8"
                      strokeDasharray={`${Math.PI * 140 * (scoreNum / 100)} ${Math.PI * 140}`}
                      strokeLinecap="round"
              ...
              {Object.keys(breakdown).length > 0 && (
                <div className="mb-12 pt-8 border-t border-gray-200 dark:border-slate-700">
                  <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-8">
                    Your BANT Breakdown
                  </h2>
                ...
                <div className="mb-6">
                  <a
                    ...
                    className={`block w-full py-4 px-6 rounded-lg font-semibold text-lg text-white text-center transition-all duration-200 hover:shadow-lg active:scale-95 ${
                      isQualified
                        ? "bg-emerald-600 dark:bg-emerald-600 hover:bg-emerald-700 dark:hover:bg-emerald-700 shadow-md hover:shadow-emerald-500/30"
                        : "bg-amber-600 dark:bg-amber-600 hover:bg-amber-700 dark:hover:bg-amber-700 shadow-md hover:shadow-amber-500/30"
                    }`}
                  >
                    {outcome.cta}
                  </a>
